...
dataset_path = r"C:\Users\User\PycharmProjects\FINALYEAR-project\DATASET"  # Corrected capitalization
train_images_path = os.path.join(r"C:\Users\User\PycharmProjects\FINALYEAR-project\DATASET", "train", "images")  # Removed redundant "train/images"
train_labels_path = os.path.join(r"C:\Users\User\PycharmProjects\FINALYEAR-project\DATASET", "train", "labels")  # Removed redundant "train/labels"
output_images_path = os.path.join(r"C:\Users\User\PycharmProjects\FINALYEAR-project\DATASET", "train", "augmented_images")  # Adjusted to keep augmented data in the same dataset folder
output_labels_path = os.path.join(r"C:\Users\User\PycharmProjects\FINALYEAR-project\DATASET", "train", "augmented_labels")  # Adjusted to keep augmented data in the same dataset folder
